export default {
  ...
  any: {
    ...
    invalid: 'contém um tipo inválido',
    empty: '!!Este campo é necessário',
    required: 'não é opcional',
    allowOnly: 'precisa ser um destes: {{valids}}',
  ...
  boolean: {
    base: 'precisa ser verdadeiro ou falso',
  },
  binary: {
  ...
  number: {
    base: '!!Este campo precisa ser um número',
    min: 'must be larger than or equal to {{limit}}',
    max: 'must be less than or equal to {{limit}}',
  ...
  string: {
    ...
    min: '!!Este campo precisa ter no mínimo {{limit}} caracteres',
    max: 'length must be less than or equal to {{limit}} characters long',
    length: 'length must be {{limit}} characters long',
    alphanum: '!!Este campo pode conter apenas caracteres alfa-numéricos',
    token: 'must only contain alpha-numeric and underscore characters',
    regex: {
            // base: 'with value "{{!value}}" fails to match the required pattern: {{pattern}}',
            // name: 'with value "{{!value}}" fails to match the {{name}} pattern'
      base: '!!Valor digitado é inválido',
      name: '!!Valor digitado é inválido',
    },
